...
class UpdateItemInventorySettingRequest extends FormRequest
{
    /**
    ...
    {
        return $this->user()->can('update', $this->route('item_inventory_setting'));
    }
    ...
    {
        $setting = $this->route('item_inventory_setting');
